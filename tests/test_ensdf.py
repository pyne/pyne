...
def test_gamma_rays():
    ...
    npt.assert_array_almost_equal(gr[0][7],
                                  [42.9962, 1.69158843, 42.3089, 0.94035401,
                                   48.7, 0.67535643, 6.06, 0.585288])
    npt.assert_array_almost_equal(gr[0][8],
                                  [[3.44278500e+02, 1.20000000e-03, 1.00000000e+02,
...
def test_origen_data():
    dat = ([(631520000, 427195231.20000005, 0.0, 3.24e-11, 0.34427890000000005, 'B-', 8.1),
            (631520000, 427195231.20000005, 0.0, 3.7e-11, 0.615399, 'B-', 8.1),
            (631520000, 427195231.20000005, 0.0, 7.3e-12, 0.7553958000000001, 'B-', 0.9),
            (631520000, 427195231.20000005, 0.0, 7.3e-12, 0.930545, 'B-', 0.315),
            (631520000, 427195231.20000005, 0.0, None, 1.04785, 'B-', 0.315),
            (631520000, 427195231.20000005, 0.0, None, 1.109173, 'B-', 0.26),
            (631520000, 427195231.20000005, 0.0, None, 1.1231849999999999, 'B-', 13.78),
            (631520000, 427195231.20000005, 0.0, None, 1.282263, 'B-', 0.035),
            (631520000, 427195231.20000005, 0.0, None, 1.3146520000000002, 'B-', 0.005),
            (631520000, 427195231.20000005, 0.0, None, 1.3184200000000001, 'B-', 0.0282),
            (631520000, 427195231.20000005, 0.0, None, 1.43402, 'B-', 2.427),
            (631520000, 427195231.20000005, 0.0, None, 1.55021, 'B-', 0.054),
            (631520000, 427195231.20000005, 0.0, None, 1.6056020000000002, 'B-', 0.101),
            (631520000, 427195231.20000005, 0.0, None, 1.6434090000000001, 'B-', 1.819),
            (631520000, 427195231.20000005, 0.0, None, 1.6924100000000002, 'B-', 0.0213)],
