...
def test_gamma_rays():
    ...
    [0, 0, 631520000, 344.2785, 0.0012, 100.0, 1.6, 0.0399, None, None, None, 19640272.0, 4306966.399999999, 966225.6],
    [0, 0, 631520000, 271.131, 0.008, 0.275, 0.008, 0.0831, None, None, None, 39343696.0, 0, 0],
    [0, 0, 631520000, 615.4, 0.1, None, None, None, None, 0.0375, 0.0011, 555737600.0, 0, 0],
    [0, 0, 631520000, 411.1163, 0.0011, 8.424, 0.016, 0.0239, None, None, None, 12062032.0, 0, 0],
    [0, 0, 631520000, 315.174, 0.017, 0.191, 0.005, 0.052, None, None, None, 25323951.999999996, 0, 0],
    [0, 0, 631520000, 586.2648, 0.0025, 1.732, 0.02, 0.0243, 0.0009, None, None, 13072464.0, 0, 0],
    [0, 0, 631520000, 930.58, 0.015, 0.275, 0.007, 0.00322, None, None, None, 1705104.0, 0, 0],
    [0, 0, 631520000, 703.25, 0.06, 0.006, 0.002, 0.00603, None, None, None, 3151284.8, 0, 0],
    [0, 0, 631520000, 493.508, 0.02, 0.037, 0.004, 0.0145, None, None, None, 7451936.0, 0, 0],
    [0, 0, 631520000, 764.9, 0.009, 0.81, 0.09, 0.00523, None, None, None, 2747112.0, 0, 0],
    [0, 0, 631520000, 1109.174, 0.012, 0.7, 0.03, 0.00224, None, None, None, 1187257.5999999999, 0, 0],
    [0, 0, 631520000, 192.6, 0.04, 0.0256, 0.0008, 0.0504, None, None, None, 26902752.0, 0, 0],
    [0, 0, 631520000, 367.7887, 0.0016, 3.245, 0.018, 0.00966, None, None, None, 5197409.6, 0, 0],
    [0, 0, 631520000, 778.904, 0.0018, 48.8, 0.07, 0.00185, None, None, None, 991486.4, 0, 0],
    [0, 0, 631520000, 173.17, 0.15, 0.03, 0.01, 0.365, None, None, None, 152196320.0, 0, 0],
    [0, 0, 631520000, 351.66, 0.04, 0.035, 0.005, 0.0375, None, None, None, 18503536.0, 0, 0],
    [0, 0, 631520000, 526.881, 0.02, 0.0495, 0.0024, 0.094, 0.008, None, None, 50521600.0, 0, 0],
    [0, 0, 631520000, 1314.7, 0.2, 0.019, 0.004, None, None, None, None, 0, 0, 0],
    [0, 0, 631520000, 195.05, 0.24, 0.023, 0.005, 0.0487, None, None, None, 26018624.0, 0, 0],
    [0, 0, 631520000, 387.9, 0.08, 0.011, 0.0008, 0.45, 0.11, None, None, 239977600.0, 0, 0],
    [0, 0, 631520000, 703.25, 0.06, 0.013, 0.003, 0.00604, None, None, None, 3151284.8, 0, 0],
    [0, 0, 631520000, 974.09, 0.04, 0.053, 0.003, 0.0056, 0.0006, None, None, 3031295.9999999995, 0, 0],
    [0, 0, 631520000, 324.83, 0.03, 0.272, 0.013, 0.063, 0.016, None, None, 32839040.0, 0, 0],
    [0, 0, 631520000, 503.474, 0.005, 0.56, 0.03, 0.0139, None, None, None, 7073024.0, 0, 0],
    [0, 0, 631520000, 678.623, 0.005, 1.777, 0.016, 0.00687, 0.00024, None, None, 3587033.6, 0, 0],
    [0, 0, 631520000, 1089.737, 0.005, 6.513, 0.024, 0.00232, None, None, None, 1231464.0, 0, 0],
    [0, 0, 631520000, 440.86, 0.1, 0.05, 0.006, 0.0197, None, None, None, 9978016.000000002, 0, 0],
    [0, 0, 631520000, 794.81, 0.03, 0.099, 0.008, 0.0077, 0.0021, None, None, 4104880.0, 0, 0],
    [0, 0, 631520000, 1206.11, 0.15, 0.053, 0.004, 0.00189, None, None, None, 1010432.0, 0, 0],
    [0, 0, 631520000, 482.31, 0.03, 0.0053, 0.0023, 0.00512, None, None, None, 2759742.4, 0, 0],
    [0, 0, 631520000, 496.39, 0.03, 0.016, 0.0016, 0.097, 0.011, None, None, 51784640.0, 0, 0],
    [0, 0, 631520000, 557.91, 0.17, 0.017, 0.007, 0.0106, None, None, None, 5456332.8, 0, 0],
    [0, 0, 631520000, 674.675, 0.003, 0.064, 0.006, 0.0076, 0.0004, None, None, 3978576.0, 0, 0],
    [0, 0, 631520000, 990.19, 0.03, 0.118, 0.005, 0.00283, None, None, None, 1496702.4000000001, 0, 0],
    [0, 0, 631520000, 1261.343, 0.023, 0.126, 0.005, 0.00271, None, None, None, 1452496.0, 0, 0],
    [0, 0, 631520000, 1605.61, 0.07, 0.0308, 0.0018, None, None, None, None, 0, 0, 0],
    [0, 0, 631520000, 209.41, 0.13, 0.0206, 0.0018, 0.0404, None, None, None, 21597984.0, 0, 0],
    [0, 0, 631520000, 520.227, 0.005, 0.196, 0.015, 0.018, 0.005, None, None, 9472800.0, 0, 0],
    [0, 0, 631520000, 534.245, 0.007, 0.161, 0.004, 0.0041, None, None, None, 2197689.6, 0, 0],
    [0, 0, 631520000, 712.843, 0.006, 0.35, 0.03, 0.00221, None, None, None, 1187257.5999999999, 0, 0],
    [0, 0, 631520000, 1299.14, 0.009, 6.12, 0.03, 0.00072, 1e-05, None, None, 387753.27999999997, 0, 0],
    [0, 0, 631520000, 937.05, 0.15, 0.013, 0.005, 0.0043, 0.0012, None, None, 2336624.0, 0, 0],
    [0, 0, 631520000, 1348.1, 0.07, 0.067, 0.004, 0.00153, None, None, None, 814660.7999999999, 0, 0]])
