...
def test_gamma_rays():
    ...
    assert_equal(gr[0][0:7], (631520000,
                 ...
                 0.26558010000000004,
                 3.0000002016666598))
    npt.assert_array_equal(gr[0][7], [[3.44278500e+02, 1.20000000e+01, 1.00000000e+02,
                1.60000000e+01, 3.99000000e-02, np.nan],
               [2.71131000e+02, 8.00000000e+00, 2.75000000e-01,
                8.00000000e+00, 8.31000000e-02, np.nan],
               [6.15400000e+02, 1.00000000e-01, np.nan,
                np.nan, np.nan, np.nan],
               [4.11116300e+02, 1.10000000e+01, 8.42400000e+00,
                1.60000000e+01, 2.39000000e-02, np.nan],
               [3.15174000e+02, 1.70000000e+01, 1.91000000e-01,
                5.00000000e+00, 5.20000000e-02, np.nan],
               [5.86264800e+02, 2.50000000e+01, 1.73200000e+00,
                2.00000000e+01, 2.43000000e-02, 9.00000000e-04],
               [9.30580000e+02, 1.50000000e+01, 2.75000000e-01,
                7.00000000e+00, 3.22000000e-03, np.nan],
               [7.03250000e+02, 6.00000000e+00, 6.00000000e-03,
                2.00000000e+00, 6.03000000e-03, np.nan],
               [4.93508000e+02, 2.00000000e+01, 3.70000000e-02,
                4.00000000e+00, 1.45000000e-02, np.nan],
               [7.64900000e+02, 9.00000000e+00, 8.10000000e-01,
                9.00000000e+00, 5.23000000e-03, np.nan],
               [1.10917400e+03, 1.20000000e-02, 7.00000000e-01,
                3.00000000e+00, 2.24000000e-03, np.nan],
               [1.92600000e+02, 4.00000000e+00, 2.56000000e-02,
                8.00000000e+00, 5.04000000e-02, np.nan],
               [3.67788700e+02, 1.60000000e+01, 3.24500000e+00,
                1.80000000e+01, 9.66000000e-03, np.nan],
               [7.78904000e+02, 1.80000000e+01, 4.88000000e+01,
                7.00000000e-02, 1.85000000e-03, np.nan],
               [1.73170000e+02, 1.50000000e+01, 3.00000000e-02,
                1.00000000e+00, 3.65000000e-01, np.nan],
               [3.51660000e+02, 4.00000000e+00, 3.50000000e-02,
                5.00000000e+00, 3.75000000e-02, np.nan],
               [5.26881000e+02, 2.00000000e+01, 4.95000000e-02,
                2.40000000e+01, 9.40000000e-02, 8.00000000e-03],
               [1.31470000e+03, 2.00000000e-01, 1.90000000e-02,
                4.00000000e+00, np.nan, np.nan],
               [1.95050000e+02, 2.40000000e+01, 2.30000000e-02,
                5.00000000e+00, 4.87000000e-02, np.nan],
               [3.87900000e+02, 8.00000000e+00, 1.10000000e-02,
                8.00000000e+00, 4.50000000e-01, 1.10000000e-01],
               [7.03250000e+02, 6.00000000e+00, 1.30000000e-02,
                3.00000000e+00, 6.04000000e-03, np.nan],
               [9.74090000e+02, 4.00000000e+00, 5.30000000e-02,
                3.00000000e+00, 5.60000000e-03, 6.00000000e-04],
               [3.24830000e+02, 3.00000000e+00, 2.72000000e-01,
                1.30000000e+01, 6.30000000e-02, 1.60000000e-02],
               [5.03474000e+02, 5.00000000e+00, 5.60000000e-01,
                3.00000000e+00, 1.39000000e-02, np.nan],
               [6.78623000e+02, 5.00000000e+00, 1.77700000e+00,
                1.60000000e+01, 6.87000000e-03, 2.40000000e-04],
               [1.08973700e+03, 5.00000000e-03, 6.51300000e+00,
                2.40000000e+01, 2.32000000e-03, np.nan],
               [4.40860000e+02, 1.00000000e+01, 5.00000000e-02,
                6.00000000e+00, 1.97000000e-02, np.nan],
               [7.94810000e+02, 3.00000000e+00, 9.90000000e-02,
                8.00000000e+00, 7.70000000e-03, 2.10000000e-03],
               [1.20611000e+03, 1.50000000e-01, 5.30000000e-02,
                4.00000000e+00, 1.89000000e-03, np.nan],
               [4.82310000e+02, 3.00000000e+00, 5.30000000e-03,
                2.30000000e+01, 5.12000000e-03, np.nan],
               [4.96390000e+02, 3.00000000e+00, 1.60000000e-02,
                1.60000000e+01, 9.70000000e-02, 1.10000000e-02],
               [5.57910000e+02, 1.70000000e+01, 1.70000000e-02,
                7.00000000e+00, 1.06000000e-02, np.nan],
               [6.74675000e+02, 3.00000000e+00, 6.40000000e-02,
                6.00000000e+00, 7.60000000e-03, 4.00000000e-04],
               [9.90190000e+02, 3.00000000e+00, 1.18000000e-01,
                5.00000000e+00, 2.83000000e-03, np.nan],
               [1.26134300e+03, 2.30000000e-02, 1.26000000e-01,
                5.00000000e+00, 2.71000000e-03, np.nan],
               [1.60561000e+03, 7.00000000e-02, 3.08000000e-02,
                1.80000000e+01, np.nan, np.nan],
               [2.09410000e+02, 1.30000000e+01, 2.06000000e-02,
                1.80000000e+01, 4.04000000e-02, np.nan],
               [5.20227000e+02, 5.00000000e+00, 1.96000000e-01,
                1.50000000e+01, 1.80000000e-02, 5.00000000e-03],
               [5.34245000e+02, 7.00000000e+00, 1.61000000e-01,
                4.00000000e+00, 4.10000000e-03, np.nan],
               [7.12843000e+02, 6.00000000e+00, 3.50000000e-01,
                3.00000000e+00, 2.21000000e-03, np.nan],
               [1.29914000e+03, 9.00000000e-03, 6.12000000e+00,
                3.00000000e+00, 7.20000000e-04, 1.00000000e-05],
               [9.37050000e+02, 1.50000000e+01, 1.30000000e-02,
                5.00000000e+00, 4.30000000e-03, 1.20000000e-03],
               [1.34810000e+03, 7.00000000e-02, 6.70000000e-02,
                4.00000000e+00, 1.53000000e-03, np.nan]])
