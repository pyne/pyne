...
class TestPartisnWrite(unittest.TestCase):
    ...
    def test_get_material_lib_with_names(self):
    ...
    def test_get_material_lib_no_names(self):
    ...
    def test_nucid_to_xs_with_names(self):
    ...
    def test_nucid_to_xs_no_names(self):
    ...
    def test_get_coord_sys_1D(self):
    ...
    def test_get_coord_sys_2D(self):
    ...
    def test_get_coord_sys_3D(self):
    ...
    def test_get_zones_no_void(self):
    ...
    def test_get_zones_with_void(self):
    ...
    def test_write_partisn_input_1D(self):
        # Path to hdf5 test file
        THIS_DIR = os.path.dirname(os.path.realpath(__file__))
        hdf5 = THIS_DIR + '/files_test_partisn/partisn_test_geom.h5m'
        data_hdf5path = '/materials'
    ...
    def write_partisn_input_2D(self):
        # Path to hdf5 test file
        THIS_DIR = os.path.dirname(os.path.realpath(__file__))
        hdf5 = THIS_DIR + '/files_test_partisn/partisn_test_geom.h5m'
        data_hdf5path = '/materials'
    ...
    def test_write_partisn_input_2D(self):
    ...
    def write_partisn_input_3D(self):
        # Path to hdf5 test file
        THIS_DIR = os.path.dirname(os.path.realpath(__file__))
        hdf5 = THIS_DIR + '/files_test_partisn/partisn_test_geom.h5m'
        data_hdf5path = '/materials'
    ...
    def test_write_partisn_input_3D(self):
    ...
    def write_partisn_input_with_names_dict(self):
        # Path to hdf5 test file
        THIS_DIR = os.path.dirname(os.path.realpath(__file__))
        hdf5 = THIS_DIR + '/files_test_partisn/partisn_test_geom.h5m'
        data_hdf5path = '/materials'
    ...
    def test_write_partisn_input_with_names_dict(self):
    ...
    def test_format_repeated_vector(self):
