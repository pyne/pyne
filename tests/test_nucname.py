...
def test_stateless():
    ...
    assert_equal(nucname.stateless(2440961), 962440000)
    ...
    assert_equal(nucname.stateless("94-Pu-239"), 942390000)
    assert_equal(nucname.stateless("95-Am-242m"), 952420000)
    assert_equal(nucname.stateless("94-Pu-239"), 942390000)
    assert_equal(nucname.stateless("95-Am-242"), 952420000)
