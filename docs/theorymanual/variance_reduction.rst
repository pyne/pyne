...
generate mesh-based weight windows or importances [2]. This method recognizes 
...
2. Process the resulting meshtally data by normalizing the fluz to have a value 
   ...
   a new weigth window file to be used for MCNP.
...
In this section, the expected results of the test_variancereduction.py 
