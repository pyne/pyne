.. _mesh_based_variance_reduction:

=============================
Mesh Based Variance Reduction
=============================

.. currentmodule:: pyne.mesh_based_variance_reduction

This page presents a detailed explanation of how :py:mod:`Mesh Based 
Variance Reduction` works, including
