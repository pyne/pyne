...
Release highlights:
  ...
  - Nuclear data updates, includeing full ENSDF support 
  - Python 3 support
  - R2S activation workflow
  - Tally class for Monte Carlo tallies
  - CADIS variance redution implementation
  - Pydagmc integration 
...
This release represnts over 976 commits, 325 files changed, 62846 insertions(+), 
