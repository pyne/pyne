...
class TestVersionHandling(unittest.TestCase):
    ...
    def test_get_version_no_git_no_archival(self, mock_check_output):
        ...
        with self.assertRaisesRegex(RuntimeError, "Not in a Git repo and .git_archival.txt is missing."):
            amalgamate.get_version()
...
class TestAmalgamatedFile(unittest.TestCase):
    ...
    def test_prepend_file_listing(self):
        ...
        self.assertTrue(content.startswith("// Amalgamated from the following files:\n"))
...
class TestMainExecution(unittest.TestCase):
    ...
    def test_main_default_args(self, mock_argv, mock_get_version):
        ...
        self.assertNotIn(self.files_map["src/utils.cpp"], header_content) # Cpp not in header
        ...
        self.assertNotIn(self.files_map["src/utils.h"], source_content) # Header not in source
