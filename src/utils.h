...
namespace pyne {
  ...
  double endftod_cpp(const char * s);
  double endftod_f(const char * s); ///< Converts a string from ENDF format to a float.
  extern  double (*endftod)(const char * s); ///< endftod function pointer. defaults to fortran
