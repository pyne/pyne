...
def print_cpp_file(filename):
    ...
    cpp_file += "   if(pyne::nucname::znum(it->first) == atomic_number ) {\n"
    ...
    cpp_file += "  atomic_mass_map[atomic_number*10000000] = element_atomic_weight;\n"
    cpp_file += " }\n"
    cpp_file += " \n"
    cpp_file += "}\n"
    cpp_file += "\n"
