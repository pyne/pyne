...
namespace endf 
{
  ...
  typedef struct list_struct {
    ...
    typedef struct mt_454_struct : mt_fpy_struct {} mt_454_struct;
    typedef struct mt_459_struct : mt_fpy_struct {} mt_459_struct;
    
    // This should be autogenerated
    typedef struct endf_library_struct {
        mt_451_struct mt_451;
        mt_454_struct mt_454;
        mt_459_struct mt_459;
    ...
    void load_dataset_to_API(int mat, int mf, int mt);
    ...
    void read_fpy(std::ifstream &infile);
