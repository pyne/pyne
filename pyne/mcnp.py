...
class PtracReader:
    def __init__(self, filename):
        ...
        self.variable_mappings = {
            ...
            12: "nsf",
            16: "ipt",
            17: "ncl", # particle id, 1 = neutron, 2 = photon, 3 = electron
            18: "mat", # maybe cell id
            19: "ncp",
            20: "xxx", # position x
            21: "yyy", # position y
            22: "zzz", # position z
    ...
    def read_headers(self):
        ...
        # problem title
        self.problem_title = self.read_next('s', auto=True)
