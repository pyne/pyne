"""This module includes the gamma effects compton edge, backscatter, single escape and double escape By using E as the intial gamma energy, these gamma effects can be calculated.
"""
...
def single_escape(E):
    ...
    if (E < 1022):	#keV
        raise ValueError('E needs to be equal to or greater than 1022 keV to be valid')
