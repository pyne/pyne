...
def _get_eaf_groups():
    ...
    This is used as a placeholder for a future PyNE implementation of a
    database storing group structures.  This hypothetical database would return
    the group structure like this method does.
