...
def _fetch_prebuilt(args):
    ...
    prebuilt_nuc_data_url = "https://github.com/aruzzo/data/raw/mass_update/prebuilt_nuc_data.h5"
	# url temporarily points to personal fork before pyne/data nuc data is updated
