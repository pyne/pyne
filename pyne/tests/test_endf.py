 ...
 ************************ C O N T E N T S ************************ 128 1451   19
 ...
 5.513700+4 1.000000+0          0          0          2          0 128 2151    2
 ...
 2.700000+3 2.000000+5          1          1          1          2 128 2151   32
 0.000000+0 0.000000+0          0          0          1 1.100000+1 128 2151   33
 0.500000+0 1.000000-1          0          0          2          0 128 2151   34
 1.000000+0 1.100000-1 2.000000+0          1         12          2 128 2151   35
 2.000000+5 1.000000+0 1.000000+1 2.000000+0 1.100000+0 3.100000+0 128 2151   36
 3.000000+6 2.000000+0 2.000000+1 3.000000+0 1.200000+0 3.200000+0 128 2151   37
 1.100000+0 1.110000-1 2.000000+0          1         12          2 128 2151   38
 3.100000+5 3.000000+0 1.100000+1 2.100000+0 2.100000+0 4.100000+0 128 2151   39
 4.100000+6 4.000000+0 2.100000+1 3.100000+0 2.200000+0 4.200000+0 128 2151   40
 2.300000+3 3.000000+5          1          1          0          1 128 2151   41
 0.000000+0 0.000000+0          0          0          1 1.100000+1 128 2151   42
 0.500000+0 1.000000-1          0          0          2          0 128 2151   43
 1.000000+0 1.100000-1 1.000000+0          1         12          2 128 2151   44
 3.000000+5 1.000000+0 1.000000+1 2.000000+0 1.100000+0 3.100000+0 128 2151   45
 4.000000+6 2.000000+0 2.000000+1 3.000000+0 1.200000+0 3.200000+0 128 2151   46
 2.197178+3 1.781069+6          1          3          1          1 128 2151   47
 0.000000+0 0.000000+0          0          0          1 2.776893-7 128 2161   48
 2.500000+0 3.699209+3-         1          0          1          0 128 2151   49
 2.399684-9 2.626370+5-2.000000+0          0          6          1 128 2151   50
 4.127773+3-3.956950-7 3.739684-5-3.872199+7 2.259559+5-3.096948-8 128 2151   51
...
def test_resolved_1_2():
 ...
 #         ER         AJ         GT         GN         GG         GF 419 2151    8
    ...
    # NRO = 0 case
    assert('AP(E)' not in data[0][2])
    # NRO = 1 case
    assert_equal(data[1][2]['AP(E)'], 11)
    # Check to see if NAPS is reading from the right place
    assert_equal(data[1][2]['AP'], 0.1)

    # Check to see if SPI, NLS are reading from the right place
    assert_equal(data[1][2]['SPI'], 0.5)
    assert_equal(data[1][2]['NLS'], 2)

    # Check to see if the data is alright...
    print data[1][3].items()#[0.5,2,2]
    assert_equal(data[1][3][0.5,2,2],
                 {'ER': 3000000.0, 'GT': 20.0, 'GN': 3.0, 'GG': 1.2,
                  'GF': 3.2, 'QX': 0.11, 'LRX': 1.0})
