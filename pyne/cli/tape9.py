"""This is a command line interface for manipulating ORIGEN v2.2 TAPE9.INP
files.
"""
...
def main_gen(ns):
    """Generates an open TAPE9.INP file. By default this only uses completely
    open data.
    """
    ...
    t9decay = gendecay(decays, branches,
...
def main():
    ...
    gen.add_argument('--metastable-cutoff', dest='metastable_cutoff',
                     default=1.0, type=float,
                     help='minimum cutoff value to be considered metastable '
                          'state, in sec.')
