...
cdef class _PairDoubleDouble:
    def __cinit__(self, first_val = None, second_val = None, bint free_pair=True):
        ...
        if first_val is not None and second_val is not None:
            ...
            self.pair_ptr = new pair[double, double](<double> first_val, <double> second_val)
            ...
            self.pair_ptr = new pair[double, double]()
    ...
    property first:
        def __get__(self):
            ...
            return float(self.pair_ptr[0].first)
        def __set__(self, first_val):


            self.pair_ptr[0].first = <double> first_val

    property second:
        def __get__(self):


            return float(self.pair_ptr[0].second)
        def __set__(self, second_val):


            self.pair_ptr[0].second = <double> second_val

    def __copy__(self):
        return _PairDoubleDouble(self.first, self.second)
...
class PairDoubleDouble(_PairDoubleDouble):
    """Wrapper class for C++ standard library pairs of type <double, double>.
    ...
    #    return _PairDoubleDouble.__cinit__(self, first_val, second_val, free_pair)
